...
echo "OPS705 Lab 3.4 Check Script"
echo
...
# Start checking of Lab 3, Investigation 2, Parts 1-3 tutorial
echo -e "\033[1mCHECKING YOUR LAB 3, INVESTIGATION 2.1-2.3 WORK:\033[0m"
echo
